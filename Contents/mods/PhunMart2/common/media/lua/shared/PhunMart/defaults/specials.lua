return {
    ...
    -- Nothing shipped inherits this any more. It stays because `kind = "vehicle"`
    -- is what makes the client label a row after the car rather than the reward
    -- (ui_utils.lua), and it is the documented Inherit for the one case a group
    -- cannot cover: several scripts sharing a single shop row.
    vehicle_base = {
        template = true,
        kind = "vehicle",
        category = "vehicle"
    ...
    -- XP rewards defined in PhunMart_XP_Rewards.json (generated file)
