-- PhunMart2 Default Pools
-- roll.mode "weighted" picks `count` offers randomly; "all" always shows everything.
return {
    ...
    -- =========================================================
    pool_goodphoods = {
        defaults = { price = "coin_5" },
        sources = { groups = { "food_fresh", "food_cooking_utensils" } },
    ...
    pool_phatphoods = {
        defaults = { price = "coin_5" },
        sources = { groups = { "food_junk", "food_alcohol" } },
        roll = { mode = "weighted", count = { min = 6, max = 9 } },
    },
    ...
    -- =========================================================
    pool_pittythetool = {
        defaults = { price = "coin_mid" },
        sources = { groups = { "tools_general" } },
    ...
    pool_finalammendment_ammo = {
        defaults = { price = "coin_low" },
        sources = { groups = { "ammo_all" } },
        roll = { mode = "weighted", count = { min = 4, max = 7 } },
    },
    pool_finalammendment_guns = {
        defaults = { price = "coin_high" },
        sources = { groups = { "weapons_firearms", "weapons_parts" } },
        roll = { mode = "weighted", count = { min = 3, max = 5 } },
    },
    pool_finalammendment_explosives = {
        defaults = { price = "coin_high" },
        sources = { groups = { "explosives" } },
    ...
    pool_vehicles_budget = {
        sources = { groups = { "vehicles_small", "vehicles_vans" } },
        roll = { mode = "all" },
    },
    pool_vehicles_standard = {
        sources = { groups = { "vehicles_normal", "vehicles_trucks", "vehicles_4x4" } },
        roll = { mode = "all" },
    },
    pool_vehicles_premium = {
        sources = { groups = { "vehicles_luxury" } },
        roll = { mode = "all" },
    },
    ...
    pool_michellescrafts = {
        defaults = { price = "coin_low" },
        sources = { groups = { "crafts_paint", "crafts_materials", "crafts_sewing" } },
        roll = { mode = "weighted", count = { min = 5, max = 8 } },
    },
    ...
    pool_radiohacks = {
        defaults = { price = "coin_mid" },
        sources = { groups = { "electronics_all" } },
        roll = { mode = "weighted", count = { min = 5, max = 8 } },
    },
    ...
    pool_phish4u = {
        defaults = { price = "coin_low" },
        sources = { groups = { "fishing_gear", "sports_gear", "camping_gear" } },
        roll = { mode = "weighted", count = { min = 5, max = 8 } },
    },
    ...
    pool_hoesnmoes = {
        defaults = { price = "coin_low" },
        sources = { groups = { "gardening_all", "animal_supplies", "trapping_gear" } },
        roll = { mode = "weighted", count = { min = 5, max = 8 } },
    },
    ...
    -- =========================================================
    pool_xp_budget = {
        sources = { categories = { "xp_t1" } },
        roll = { mode = "weighted", count = { min = 4, max = 6 } },
    },
    pool_xp_gifted = {
        sources = { categories = { "xp_t2" } },
        roll = { mode = "weighted", count = { min = 4, max = 6 } },
    },
    pool_xp_luxury = {
        sources = { categories = { "xp_t3" } },
        roll = { mode = "weighted", count = { min = 3, max = 5 } },
    },
    pool_boost_budget = {
        sources = { categories = { "boost_t1" } },
        roll = { mode = "weighted", count = { min = 2, max = 4 } },
    },
    pool_boost_gifted = {
        sources = { categories = { "boost_t2" } },
        roll = { mode = "weighted", count = { min = 2, max = 4 } },
    },
    pool_boost_luxury = {
        sources = { categories = { "boost_t3" } },
    ...
    pool_hardwear = {
        defaults = { price = "coin_low" },
        sources = { groups = { "clothing_all", "protective_gear" } },
        roll = { mode = "weighted", count = { min = 5, max = 8 } },
    },
    ...
    pool_shedsandcommoners = {
        defaults = { price = "coin_mid" },
        sources = { groups = { "skill_books_all" } },
        roll = { mode = "weighted", count = { min = 4, max = 7 } },
    },
